...
ciudades_visitadas.remove ("San Luis")
ciudades_visitadas.remove ("Bs As")
...
dic_familiar ["11852841"] = "Abuela Paterna Coca"
dic_familiar ["12456951"] = "Abuela Materna Marta"
dic_familiar ["25456951"] = "Prima Marisol"
...
for i in range(3):
    clave = f"persona{i + 1}"
    numero = "5" + "".join(str(random.randint(0, 9)) for _ in range(8))
